            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <form action="{{ route('clients.update', $client) }}" method="POST">
                    ...
                    <div class="mt-10 pt-6 border-t border-gray-100 flex justify-between items-center">
                        <button type="submit" form="delete-form" class="text-rose-600 hover:text-rose-800 font-bold text-sm transition-colors decoration-rose-200 underline underline-offset-4">
                            Delete Client
                        </button>
                ...
                <form id="delete-form" action="{{ route('clients.destroy', $client) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this client? This action cannot be undone.')">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
