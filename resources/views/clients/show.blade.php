    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('invoices.create', ['client_id' => $client->id]) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition ease-in-out duration-150">
                    New Invoice
                </a>
            </div>
        </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        <div class="flex flex-col items-center text-center mb-6">
                            ...
                            <p class="text-gray-500 font-medium">{{ $client->company }}</p>
                        </div>
                        ...
                        <div class="space-y-4 pt-6 border-t border-gray-50">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-xs font-semibold text-gray-400 uppercase">Tax ID</p>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                            ...
                            <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">{{ $client->invoices->count() }} total</span>
                        </div>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-gray-50/30 border-b border-gray-100">
                                        ...
                                        <th class="px-6 py-3 text-xs font-semibold text-gray-400 uppercase text-right">Amount</th>
                                        <th class="px-6 py-3 text-xs font-semibold text-gray-400 uppercase text-center">Status</th>
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 font-bold text-gray-900 text-right">${{ number_format($invoice->total, 2) }}</td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-8 text-center text-gray-400 font-medium italic">No invoices found for this client.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
